...
app.directive('datePicker', function ($timeout, $window) {
    return {
        ...
        link: function (scope, element, attrs, ctrl, transclude) {
            ...
            scope.days = [
                { "long":"Sunday","short":"კვ" },
                { "long":"Monday","short":"ორშ" },
                { "long":"Tuesday","short":"სამ" },
                { "long":"Wednesday","short":"ოთხ" },
                { "long":"Thursday","short":"ხუთ" },
                { "long":"Friday","short":"პარ" },
                { "long":"Saturday","short":"შაბ" },
            ];
